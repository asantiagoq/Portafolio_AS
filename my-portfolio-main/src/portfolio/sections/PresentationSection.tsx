    ...
    return (
        <section className="container">
            <motion.article whileInView={'visible'} viewport={{once: true}} variants={containerLeft} className="container__left">
                ...
                <WordAnimation show='Angel Santiago' velocity={300}/>
                <WordAnimation show='Front-End y' velocity={300}/>
                <WordAnimation show='Analista de Seguridad Informatica' velocity={300}/>
                <p className='presentation__text'>
                Ingeniero de Sistemas de la Universidad Nacional de San
                Agustín, con más de 2 años de experiencia desarrollando aplicaciones web y móviles.Mi enfoque se
                centra en la creación de soluciones innovadoras, adaptadas a las necesidades de proyectos
                académicos y empresariales. Estoy preparado para contribuir al crecimiento y la mejora
                continua de una organización, aportando mis habilidades técnicas, compromiso y pasión por
                la tecnología.
